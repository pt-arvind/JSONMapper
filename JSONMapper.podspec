#
#  Be sure to run `pod spec lint JSONMapper.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.homepage     = "https://github.com/jlalvarez18/JSONMapper"
  ...
  s.author    = "Juan Alvarez"
  # s.authors            = { "Juan Alvarez" => "" }
  # s.social_media_url   = "http://twitter.com/Juan Alvarez"
